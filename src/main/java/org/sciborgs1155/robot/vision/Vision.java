...
public class Vision {
    ...
    public Vision() {
        ...
        frontPhotonEstimator = new PhotonPoseEstimator(
        ...
        rearPhotonEstimator =
                new PhotonPoseEstimator(
                        VisionConstants.TAG_LAYOUT, PoseStrategy.MULTI_TAG_PNP_ON_COPROCESSOR, rearCamera, VisionConstants.ROBOT_TO_CAM);
     ...
     */
    public Matrix<N3, N1> getEstimationStdDevs(Pose2d estimatedPose, PhotonCamera camera, PhotonPoseEstimator estimator) {
