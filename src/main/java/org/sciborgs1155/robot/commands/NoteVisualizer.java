...
public class NoteVisualizer implements Logged {
  ...
  public static void startPublishing() {
    ...
    StructArrayTopic<Pose3d> poseTopic = inst.getStructArrayTopic("notePose", Pose3d.struct);
    posePub = poseTopic.publish();

    StructArrayTopic<Pose3d> path = inst.getStructArrayTopic("notePath", Pose3d.struct);
